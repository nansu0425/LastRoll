...
struct FCapsule : public IBoundingVolume
{
	...
	FCapsule();
	FCapsule(const FVector& InCenter, float InHalfHeight, float InRadius);
	FCapsule(const FVector& InCenter, float InHalfHeight, float InRadius, const FQuaternion& InOrientation);
