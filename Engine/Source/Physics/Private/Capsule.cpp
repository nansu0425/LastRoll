...
FCapsule::FCapsule(const FVector& InCenter, float InHalfHeight, float InRadius)
	: Center(InCenter)
...
FCapsule::FCapsule(const FVector& InCenter, float InHalfHeight, float InRadius, const FQuaternion& InOrientation)
	: Center(InCenter)
	, HalfHeight(InHalfHeight)
	, Radius(InRadius)
...
FVector FCapsule::GetTopSphereCenter() const
{
	// 캡슐의 상단 반구 중심
...
FVector FCapsule::GetBottomSphereCenter() const
{
	// 캡슐의 하단 반구 중심
	// Z축 방향으로 -HalfHeight만큼 이동
	FVector Axis = GetAxis();
...
FVector FCapsule::GetAxis() const
{
...
bool FCapsule::Intersects(const FCapsule& Other) const
{
...
bool FCapsule::Intersects(const FBoundingSphere& Other) const
{
...
bool FCapsule::Intersects(const FAABB& Other) const
{
