...
function BeginPlay()
    ...
    local PrimitiveComponent = GetPrimitiveComponentByName("UBoxComponent_2");
    
    if PrimitiveComponent then 
        PrimitiveComponent:BindBeginOverlap(self, OnBeginOverlap)
        PrimitiveComponent:BindBeginOverlap(self, OnBeginOverlapTest)
        PrimitiveComponent:BindEndOverlap(self, OnEndOverlap)
    end
...
function OnBeginOverlapTest(OtherActor)
    print("Test Message")
    print("Hello World")
end
